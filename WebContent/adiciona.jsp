					...
					<div class="modal-body modal-spa">
						<div class="login-form">			
							<form action="mvc" method="POST" id="signup">
								<ol>
									<li>
										<input type="text" id="nomeContato" name="nome" placeholder="Digite seu nome" title="Nome" required />	
									</li>
									<li>
										<input type="text" id="telefone" name="telefone" placeholder="(35)99199-1835" title="Telefone" required />
									</li>
									<li>
										<input type="email" id="email" name="email" placeholder="email@exemplo.com" title="Por favor digite um email válido" required />
